...
class StockItem(models.Model):
    ...
    def get_json(self):
        ...
        result["quantity"] = None # For frontend
        ...
        result["tax_rate"] = self.tax_rate if self.tax_rate else None
...
class Recipe(models.Model):
    ...
    #     }
    # ]
    produced_item = models.OneToOneField('StockItem', help_text='Select the item for which you want to create a recipe')
...
class PurchaseOrderItem(models.Model):
    purchase_order = models.ForeignKey('PurchaseOrder', help_text='Select purchase order')
...
class SaleOrder(models.Model):
    ...
    from_department = models.ForeignKey('department.Department', help_text='department from which stock should be removed if sale order is complete')
...
class SaleOrderItem(models.Model):
    sale_order = models.ForeignKey('SaleOrder', help_text='Select Sale order')
...
class StockTransferRequestItem(models.Model):
    stock_transfer_request = models.ForeignKey('StockTransferRequest', help_text='Select stock transfer request')
...
class SystemStockVerificationCheckpointItem(models.Model):
    system_stock_verification_checkpoint = models.ForeignKey('SystemStockVerificationCheckpoint', help_text='Select system stock verification checkpoint')
...
class ManualStockVerificationCheckpointItem(models.Model):
    manual_stock_verification_checkpoint = models.ForeignKey('ManualStockVerificationCheckpoint', help_text='Select manual stock verification checkpoint')
...
class StockVerificationCheckpointReport(models.Model):
    ...
    def __str__(self):
        return u'%s, SSVC: %s, MSVC: %s' % (self.pk, self.system_stock_verification_checkpoint, self.manual_stock_verification_checkpoint)
